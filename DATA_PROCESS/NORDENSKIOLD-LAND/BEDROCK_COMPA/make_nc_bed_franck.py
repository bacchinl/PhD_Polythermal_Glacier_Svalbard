...
exclude = [ 940]# 333, 355, 940] ## 333 and 355 in nordenskioldland and 940 is just fucked up
plot_tuile = False
# --- chemins ---
raster_dir = os.path.expanduser("~/PhD_Lucie/DATA/BEDROCK/Thomas_Frank/Topg/RGI-07_topg/topg_final/")
shp_path = "~/PhD_Lucie/DATA/Maps/Shapefiles_regions/mask_nordenskioldland.shp"
...
out_path = os.path.join(".", "mosaic_nordenskiold_land_franck.tif")
