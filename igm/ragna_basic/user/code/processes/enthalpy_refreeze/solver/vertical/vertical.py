...
def update_vertical(cfg: DictConfig, state: State) -> None:
    ...
    cfg_drainage = cfg.processes.enthalpy_refreeze.drainage
    cfg_physics = cfg.processes.iceflow.physics
    cfg_solver = cfg.processes.enthalpy_refreeze.solver
    ...
    dzeta = state.iceflow.discr_v.enthalpy_refreeze.dzeta
    V_U_to_E = state.iceflow.discr_v.enthalpy_refreeze.V_U_to_E
